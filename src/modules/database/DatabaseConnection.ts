...
import ProductEntity from "../store/product/entities/product.entity";
import SaleEntity from "../store/sale/entities/sale.entity";
import SaleDetailEntity from "../store/sale-details/entities/sale-details.entity";
...
export class DatabaseConnection {
    ...
    public static appDataSource: DataSource = new DataSource({
        ...
        entities: [
            ...
            SaleEntity,
            SaleDetailEntity,
        ], // Lista de entidades que manejará TypeORM en la base de datos.
